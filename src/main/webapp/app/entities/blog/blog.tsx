...
export const Blog = (props: IBlogProps) => {
  ...
  return (
    <div>
      <h2 id="blog-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.blog.home.title">Blogs</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.blog.home.createLabel">Create new Blog</Translate>
        </Link>
      </h2>
        ...
        {blogList && blogList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.blog.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.blog.handle">Handle</Translate>
                </th>
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.blog.user">User</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.blog.home.notFound">No Blogs found</Translate>
            </div>
          )
        )}
      </div>
