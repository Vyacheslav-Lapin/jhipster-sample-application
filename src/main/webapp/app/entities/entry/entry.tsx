...
export const Entry = (props: IEntryProps) => {
  ...
  return (
    <div>
      <h2 id="entry-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.entry.home.title">Entries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.entry.home.createLabel">Create new Entry</Translate>
        </Link>
      </h2>
          ...
          {entryList && entryList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('title')}>
                    <Translate contentKey="jhipsterSampleApplicationApp.entry.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('content')}>
                    <Translate contentKey="jhipsterSampleApplicationApp.entry.content">Content</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('date')}>
                    <Translate contentKey="jhipsterSampleApplicationApp.entry.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="jhipsterSampleApplicationApp.entry.blog">Blog</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jhipsterSampleApplicationApp.entry.home.notFound">No Entries found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
