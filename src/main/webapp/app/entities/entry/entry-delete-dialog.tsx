...
export const EntryDeleteDialog = (props: IEntryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.entry.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.entry.delete.question" interpolate={{ id: entryEntity.id }}>
