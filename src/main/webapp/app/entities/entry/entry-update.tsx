  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.entry.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.entry.home.createOrEditLabel">Create or edit a Entry</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : entryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="titleLabel" for="entry-title">
                  <Translate contentKey="jhipsterSampleApplicationApp.entry.title">Title</Translate>
                </Label>
                <AvField
                  id="entry-title"
                  type="text"
              ...
              <AvGroup>
                <Label id="contentLabel" for="entry-content">
                  <Translate contentKey="jhipsterSampleApplicationApp.entry.content">Content</Translate>
                </Label>
                <AvInput
                  id="entry-content"
                  type="textarea"
              ...
              <AvGroup>
                <Label id="dateLabel" for="entry-date">
                  <Translate contentKey="jhipsterSampleApplicationApp.entry.date">Date</Translate>
                </Label>
                <AvInput
                  id="entry-date"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label for="entry-blog">
                  <Translate contentKey="jhipsterSampleApplicationApp.entry.blog">Blog</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="entry-tag">
                  <Translate contentKey="jhipsterSampleApplicationApp.entry.tag">Tag</Translate>
                </Label>
                <AvInput
                  id="entry-tag"
                  type="select"
