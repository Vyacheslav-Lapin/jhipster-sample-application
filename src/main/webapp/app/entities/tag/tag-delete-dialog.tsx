...
export const TagDeleteDialog = (props: ITagDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.tag.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.tag.delete.question" interpolate={{ id: tagEntity.id }}>
