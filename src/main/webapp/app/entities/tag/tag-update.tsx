  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.tag.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : tagEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="tag-name">
                  <Translate contentKey="jhipsterSampleApplicationApp.tag.name">Name</Translate>
                </Label>
                <AvField
                  id="tag-name"
                  type="text"
